...
<!-- 
	File:    index.php
	Purpose: Upload CSV file to Database
          ...
          function processUploads(){
            ...
            if(!is_dir('uploads') || !is_writable("uploads")){ 
              ...
              if (!$success){
                ...
                //} else {
                //   $stmt = $db_conn->prepare("insert into lab4 (person_name,person_age,person_dio, file_name,store_file_name,file_uploaded,filesize,file_type) 
                //                              values(?, ?, ?, ?, ?, ?, ?, ?)");
                //           if (!$stmt){
                //               $status = "PrepareFail";
                //           } else {
                //     $person_name = $_SESSION['name'];
                //     $person_age  = $_SESSION['age'];
                //     $person_bio  = $_SESSION['bio'];
                //     $file_name   = $_FILES['uploads']['name'];
                //     $store_file_name = $newName;
                //     $_SESSION['store_file_name'] = $store_file_name;
                //     $file_uploaded =  date('Y/m/d'); 
                //     $filesize =  $_FILES['uploads']['size'];
                //     $file_type =  $_FILES['uploads']['type'];
    
                //               $data = array($person_name, $person_age,$person_bio, $file_name,$store_file_name,$file_uploaded,$filesize,$file_type);
